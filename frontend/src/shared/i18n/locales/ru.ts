const ru = {
  ...
  workouts: {
    title: "Offline занятия",
    subtitle: "Ваши записи на занятия с тренером",
    empty: "Вы пока не записаны ни на одно занятие",
    subscription: "Абонемент",
    classesLeft: "занятий осталось",
    classesCount: "занятий",
    maxExtensions: "Переносов",
    validUntil: "Действует до",
    extensions: "Переносов использовано",
    noSubscription: "Нет активного абонемента — купите тариф ниже",
    schedule: "Расписание",
    filterByTrainer: "Тренер",
    allTrainers: "Все тренеры",
    legendEnrolled: "Вы записаны",
    legendAvailable: "Доступные занятия",
    plansTitle: "Купить занятия",
    buy: "Купить",
    myClasses: "Мои занятия",
  },
  calendar: {
    title: "Расписание занятий",
    createEvent: "Новое занятие",
    eventTitle: "Название",
    eventTrainer: "Тренер",
    noTrainers: "Тренеры не найдены",
    eventStart: "Начало",
    eventEnd: "Конец",
    eventMaxParticipants: "Мест (макс.)",
    ...
    csrfError: "Сессия устарела — войдите заново",
    enrollments: "Записи",
    noEnrollments: "Записей нет",
    markAllAttended: "Все присутствовали",
    markAllAbsent: "Все отсутствовали",
    status: {
    ...
    enrollmentStatus: {
      enrolled: "Записан",
      notified_absent: "Уведомил об отсутствии",
      attended: "Присутствовал",
      absent_extended: "Отсутствовал (продлено)",
      missed: "Пропустил",
      cancelled: "Отменено",
    },
  },
