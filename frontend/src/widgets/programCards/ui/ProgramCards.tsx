...
type ProgramCardSize = "small" | "middle" | "high";
  ...
  return (
    <Grid container spacing={2}>
      {items.map((item) => {
        ...
        const isDisabled = !hasAccess || !item.href;
        const itemActionLabel = item.actionLabel ?? (hasAccess ? actionLabel : disabledActionLabel);
                    ...
                    <Grid container spacing={1.5}>
                      ...
                      {itemActionLabel ? (
                        <Grid size={{ xs: 12, sm: 4 }}>
                          <Button
                            fullWidth
                            component={!isDisabled && item.href ? Link : "button"}
                            ...
                            sx={{
                              ...
                              px: 2,
                              borderRadius: 999,
                              bgcolor: hasAccess ? "rgba(184, 159, 116, 0.18)" : "rgba(95, 88, 79, 0.12)",
